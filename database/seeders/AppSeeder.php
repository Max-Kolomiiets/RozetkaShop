...
class AppSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i=0; $i < $this->vendors_cnt; $i++) { 
            $this->Vendors = Vendor::factory()->create(['country_id'=> $this->Countries->all()[rand(0, $this->countries_cnt - 1)]->id]);
        }
        ...
        $Products->each(function($p){
            ...
            Guaranty::factory()->create(['product_id'=>$p->id, 'vendor_id'=>$p->vendor_id]);
