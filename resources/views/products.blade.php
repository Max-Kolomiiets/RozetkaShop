        ...
        <div class="flex-column col filltres">
            <form action="{{route("category.filltering", $category->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price-min" onchange="this.form.submit()" value="{{$formstates->prices->value_min}}">
                    <br>
                    <label for="price-max">до</label>
                    <input type="number" name="price-max" onchange="this.form.submit()" value="{{$formstates->prices->value_max}}">
                </div>
                <div class="form-group">
                    <h5>Виробник</h5>
